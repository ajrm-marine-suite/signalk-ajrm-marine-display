...
export function createAppDom() {
	...
	const locationTideControls = {
		...
		weatherUnavailable: getRequiredElement("weatherUnavailable"),
		weatherFallback: getRequiredElement("weatherFallback"),
		weatherLocationName: getRequiredElement("weatherLocationName"),
		weatherDistanceLabel: getRequiredElement("weatherDistanceLabel"),
		weatherDistance: getRequiredElement("weatherDistance"),
		weatherSelection: getRequiredElement("weatherSelection"),
		weatherSourceFreshness: getRequiredElement("weatherSourceFreshness"),
		weatherStatus: getRequiredElement("weatherStatus"),
		weatherTable: getRequiredElement("weatherForecastTable"),
		refreshWeather: getRequiredElement("buttonRefreshWeather"),
